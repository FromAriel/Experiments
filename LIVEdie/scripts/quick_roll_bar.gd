...
@export var qrb_chip_font_size: int = 20
@export var qrb_history_font_size: int = 20
...
func _ready() -> void:
    ...
    qrb_history_panel.rh_entry_font_size = qrb_history_font_size
    _build_custom_panel()
    _qrb_apply_scale()
...
func _update_queue_display() -> void:
    ...
    for entry in qrb_queue:
        ...
        chip.add_theme_font_size_override("font_size", int(qrb_chip_font_size * qrb_size_index))
